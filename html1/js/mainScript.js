        ...
        if (!e) {
            ...
            for (c = 0; c < i.length; c++)
                if (d = i[c], !d.getAttribute("data-secret")) {
                    if (f = Math.random().toString(36).substr(2, 10), d.src += "#?secret=" + f, d.setAttribute("data-secret", f), g || h)
...
!function($, e, t, a) {
    var r = function() {
            ...
            for (var e = 7; e > 0; e--) {
                ...
                if (r.innerHTML = "<!--[if IE " + e + "]><span></span><![endif]-->", r.getElementsByTagName("span").length)
                    return r = null, e;
                r = null
            }
            return a
        ...
        function g(e, t) {
            ...
            if (3 === e.nodeType && e.data.length) {
                ...
                for (var m = 0; m < e.childNodes.length; m++)
                    f.nodeBeginning = !0, m += g(e.childNodes[m], t);
            return r
        }
        function p(t, s) {
        ...
        if (m.search.length && ("string" == typeof m.search || /^\d/.test(parseFloat(m.search))))
            ...
            default:
                if (!(m.delimiter instanceof RegExp))
                    return n.log(i + ": Unrecognized delimiter, empty search string, or invalid custom Regex. Aborting."), !0;
                h = m.delimiter
            }
